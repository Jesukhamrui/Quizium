...
const StartScreen = ({ playerName, setPlayerName, startQuiz }) => {
  return (
    <div className="text-center">
      <h2 className="text-3xl font-bold mb-8 text-white">🎓 Computer Science Quiz Challenge</h2>
      <p className="text-lg text-gray-300 mb-8">Test your knowledge across various computer science subjects!</p>
